...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('assets/css/styledb.css') ?>">
  <link rel="stylesheet" href="<?= base_url('assets/css/vendor.css') ?>">
  <link rel="stylesheet" href="<?= base_url('assets/icomoon/icomoon.css') ?>">
...
<body data-user-id="<?= session()->get('id') ?>" data-username="<?= esc(session()->get('username')) ?>">
